...
| **Google gemini-embedding-001** | 768/1536/3072(MRL) | 未確認(旧世代情報との混同疑い) | MTEB Multilingual 平均 68.32 で首位級だが**多言語平均**。JMTEB 個別スコア未確認 | 標準 $0.15 / バッチ $0.075 | 単純 REST(Gemini API) | 2026年 GA 直後で実績が浅い |
